    ...
    >
      <div className="space-y-6 flex flex-col justify-center items-center text-center lg:text-left lg:px-24 xl:px-40 lg:items-start">
        <div className="flex space-x-2">
          ...
          <h4 className="text-orange">Contact Me</h4>
        </div>
        <div>
          <h2 className="font-bold text-3xl text-white">Let's Work Together</h2>
        </div>
        <div>
          <p className="text-abu text-center lg:text-left">
        ...
        <div className="space-y-5">
          <div className="flex items-center space-x-3">
            ...
            <h4 className="text-abu">Ciamis - Jawa Barat - Indonesia</h4>
          </div>
          <div className="flex items-center space-x-3">
            <div className="bg-abu bg-opacity-10 p-2 rounded-md">
              <svg
          ...
          <div className="flex items-center space-x-3">
            ...
            <h4 className="text-abu">+6285157554036</h4>
          </div>
        </div>
      </div>
      <div className="flex flex-col w-full sm:px-20">
        <form className="space-y-5 " name="submit-form">
          <input
            ...
            name="name"
            placeholder="Name"
            className="w-full h-14 text-abu bg-abu px-3 py-2 rounded-md bg-opacity-10 placeholder-abu block focus:outline-none focus:ring-2 focus:ring-orange focus:border-orange"
          />
          <input
            type="email"
            name="email"
            placeholder="Email Address"
            className="w-full h-14 text-abu bg-abu px-3 py-2 rounded-md bg-opacity-10 placeholder:text-abu block focus:outline-none focus:ring-2 focus:ring-orange focus:border-orange invalid:text-orange invalid:focus:ring-orange invalid:focus:border-orange peer"
          />
          ...
          <input
            ...
            name="subject"
            placeholder="Subject"
            className="w-full h-14 text-abu bg-abu px-3 py-2 rounded-md bg-opacity-10 placeholder:text-abu block focus:outline-none focus:ring-2 focus:ring-orange focus:border-orange"
          />
          <textarea
            id="message"
            rows="4"
            className="block p-2.5 w-full text-abu bg-abu bg-opacity-10 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange focus:border-orange placeholder:text-abu"
            placeholder="Message"
            name="message"
          ></textarea>
